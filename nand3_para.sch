...
C {sky130_stdcells/inv_1.sym} 640 -580 0 0 {name=x2 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} 720 -580 3 0 {name=p6 sig_type=std_logic lab=out1}
