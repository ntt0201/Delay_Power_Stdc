...
C {devices/lab_pin.sym} 130 -30 3 0 {name=p2 sig_type=std_logic lab=out}
C {devices/vsource.sym} -190 60 0 0 {name=Vin value="pulse( 0 0.8 0.0001ns .3ns .3ns 20ns 40ns)"
}
...
C {sky130_stdcells/inv_1.sym} 190 -30 0 0 {name=x2 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} 260 -30 3 0 {name=p6 sig_type=std_logic lab=out1}
